const Navbar = () => {
  return (
    // <header classNameName="sticky inset-x-0 top-0 z-50 w-full border-b border-white bg-[#121212] px-4">
    //   <nav classNameName="mx-auto flex max-w-7xl items-center py-2">
    //     <div classNameName="mr-4 w-12 shrink-0 sm:w-16">
    //       <svg
    //         classNameName="width:100%"
    //         viewBox="0 0 63 64"
    //         fill="none"
    ...
    //           style="--darkreader-inline-stroke: #bdf6ff;"
    //         ></path>
    //         <path
    ...
    //           style="--darkreader-inline-fill: #bdf6ff;"
    //         ></path>
    //         <path
    ...
    //           fill="#232323"
    //           data-darkreader-inline-fill=""
    //           style="--darkreader-inline-fill: #d2cec8;"
    //         ></path>
    //         <defs>
    //           <linearGradient
    ...
    //               style="--darkreader-inline-stopcolor: #0065c6;"
    //             ></stop>
    //             <stop
    //               offset="1"
    //               stopColor="#FF4A9A"
    //               data-darkreader-inline-stopcolor=""
    //               style="--darkreader-inline-stopcolor: #a00047;"
    //             ></stop>
    //           </linearGradient>
    //         </defs>
    //       </svg>
    //     </div>
    //     <div classNameName="relative mx-auto hidden w-full max-w-md overflow-hidden sm:block">
    //       <input
    //         classNameName="w-full border bg-transparent py-1 pl-8 pr-3 placeholder-white outline-none sm:py-2"
    //         placeholder="Search"
    //       />
    //       <span classNameName="absolute left-2.5 top-1/2 inline-block -translate-y-1/2">
    //         <svg
    //           xmlns="http:www.w3.org/2000/svg"
    //           fill="none"
    //           viewBox="0 0 24 24"
    ...
    //       </span>
    //     </div>
    //     <button classNameName="ml-auto sm:hidden">
    //       <svg
    //         xmlns="http:www.w3.org/2000/svg"
    //         fill="none"
    //         viewBox="0 0 24 24"
    ...
    //       </svg>
    //     </button>
    //     <button classNameName="group peer ml-4 flex w-6 shrink-0 flex-wrap gap-y-1.5 sm:hidden">
    //       <span classNameName="block h-[2px] w-full bg-white group-hover:bg-[#ae7aff]"></span>
    //       <span classNameName="block h-[2px] w-2/3 bg-white group-hover:bg-[#ae7aff]"></span>
    //       <span classNameName="block h-[2px] w-full bg-white group-hover:bg-[#ae7aff]"></span>
    //     </button>
    //     <div classNameName="fixed inset-y-0 right-0 flex w-full max-w-xs shrink-0 translate-x-full flex-col border-l border-white bg-[#121212] duration-200 hover:translate-x-0 peer-focus:translate-x-0 sm:static sm:ml-4 sm:w-auto sm:translate-x-0 sm:border-none">
    //       <div classNameName="relative flex w-full items-center justify-between border-b border-white px-4 py-2 sm:hidden">
    //         <span classNameName="inline-block w-12">
    //           <svg
    //             style="width:100%"
    //             viewBox="0 0 63 64"
    //             fill="none"
    ...
    //           </svg>
    //         </span>
    //         <button classNameName="inline-block w-8">
    //           <svg
    //             xmlns="http:www.w3.org/2000/svg"
    //             fill="none"
    //             viewBox="0 0 24 24"
    ...
    //         </button>
    //       </div>
    //       <ul classNameName="my-4 flex w-full flex-wrap gap-2 px-4 sm:hidden">
    //         <li classNameName="w-full">
    //           <button classNameName="flex w-full items-center justify-start gap-x-4 border border-white px-4 py-1.5 text-left hover:bg-[#ae7aff] hover:text-black focus:border-[#ae7aff] focus:bg-[#ae7aff] focus:text-black">
    //             <span classNameName="inline-block w-full max-w-[20px] group-hover:mr-4 lg:mr-4">
    //               <svg
    //                 style="width:100%"
    //                 viewBox="0 0 22 22"
    //                 fill="none"
    ...
    //         </li>
    //       </ul>
    //       <div classNameName="mb-8 mt-auto flex w-full flex-wrap gap-4 px-4 sm:mb-0 sm:mt-0 sm:items-center sm:px-0">
    //         <button classNameName="w-full bg-[#383737] px-3 py-2 hover:bg-[#4f4e4e] sm:w-auto sm:bg-transparent">
    //           Log in
    //         </button>
    //         <button classNameName="mr-1 w-full bg-[#ae7aff] px-3 py-2 text-center font-bold text-black shadow-[5px_5px_0px_0px_#4f4e4e] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4f4e4e] sm:w-auto">
    //           Sign up
    //         </button>
    //       </div>
    //     </div>
